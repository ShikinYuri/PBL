    ...
    <div style="background-color: #fff; padding: 20px; margin-bottom: 20px; border-radius: 5px;">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(250px, 1fr)); gap: 15px;">
            <c:forEach items="${sections}" var="section">
                <a href="/section/${section.id}" style="display: block; padding: 15px; background-color: #f8f9fa; border-radius: 5px; text-decoration: none; color: #333; transition: all 0.3s;">
